...
const en = {
  ...
  hero: {
    ...
    body: "Production iOS & Android, from React Native & TypeScript down to native modules in Kotlin/Java. Most recently at Diehl Metering, Nuremberg.",
  ...
  about: {
    ...
    p1: "Most React Native developers stop at JavaScript. My work consistently goes one layer deeper into the Kotlin and Java that the JS layer talks to. At Diehl Metering I built an Android Auto extension as a native module inside a production React Native app, bridging the JavaScript layer to native vehicle code.",
  ...
  exp: {
    ...
    items: [
      { when: "03/2026 \u2013 08/2026", role: "Working Student React Native Developer", org: "Diehl Metering GmbH", place: "Nuremberg, DE", points: ["Built an Android Auto extension as a native module in a production React Native app", "Bridged the JavaScript layer to native Kotlin/Java for in-vehicle functionality", "Maintained code quality through reviews and close work with the mobile team"] },
  ...
  work: {
    ...
    flagshipTag: "Flagship · Full-stack Kotlin",
    flagshipName: "Perks - KMP wallet + Kotlin backend",
    flagshipBody: "One Kotlin codebase shared logic and Compose UI running natively on Android and iOS, no SwiftUI. Backed by my own Kotlin / Spring Boot REST API (JWT auth, PostgreSQL, Docker, CI). Offline-first, encrypted card storage, and shared tests running on both platforms.",
    flagshipStack: ["Kotlin Multiplatform", "Compose MP", "Ktor", "SQLDelight", "Spring Boot", "JWT", "PostgreSQL"],
    flagshipCta: "App repo",
    backendCta: "Backend repo",
    ghCta: "See all my code",
  },
  products: {
    eyebrow: "Products",
    title: "Products I built solo",
    sub: "Apps I designed, built and shipped end-to-end live on the stores, in public.",
    cards: [
      { tag: "Personal product · live on Play", name: "DiviSum", org: "Built & published solo · Germany", body: "A privacy-first bill-splitter for flatmates, trips and couples: one shared ledger across all your groups, smart expense categorization in English and German, and debt-simplification that settles everyone in the fewest transfers. No ads, no paywall, no tracking data stored in the EU. Designed, built and shipped end-to-end by me.", stack: ["Privacy-first", "EN / DE", "Multi-currency", "Dark mode"], ios: "", android: "https://play.google.com/store/apps/details?id=com.divisum" },
    ],
  },
  contact: {
    eyebrow: "Contact",
...
const de: Dict = {
  ...
  hero: {
    ...
    line4: "darunter.",
    body: "Produktive iOS- & Android-Apps von React Native & TypeScript bis zu nativen Modulen in Kotlin/Java. Zuletzt bei Diehl Metering, N\u00fcrnberg.",
  ...
  about: {
    ...
    p1: "Die meisten React-Native-Entwickler h\u00f6ren bei JavaScript auf. Meine Arbeit geht konsequent eine Ebene tiefer in den Kotlin- und Java-Code, mit dem die JS-Schicht spricht. Bei Diehl Metering habe ich eine Android-Auto-Erweiterung als Native Module in einer produktiven React-Native-App entwickelt.",
  ...
  work: {
    ...
    flagshipTag: "Flagship · Full-Stack Kotlin",
    flagshipName: "Perks - KMP-Wallet + Kotlin-Backend",
    flagshipBody: "Eine Kotlin-Codebasis gemeinsame Logik und Compose-UI nativ auf Android und iOS, ohne SwiftUI. Dazu ein eigenes Kotlin-/Spring-Boot-REST-API (JWT-Auth, PostgreSQL, Docker, CI). Offline-first, verschl\u00fcsselte Kartenspeicherung und geteilte Tests auf beiden Plattformen.",
    flagshipStack: ["Kotlin Multiplatform", "Compose MP", "Ktor", "SQLDelight", "Spring Boot", "JWT", "PostgreSQL"],
    flagshipCta: "App-Repo",
    backendCta: "Backend-Repo",
  ...
  products: {
    eyebrow: "Produkte",
    title: "Produkte, die ich allein gebaut habe",
    sub: "Apps, die ich end-to-end entworfen, entwickelt und ver\u00f6ffentlicht habe live in den Stores.",
    cards: [
      { tag: "Eigenes Produkt · live im Play Store", name: "DiviSum", org: "Allein entwickelt & ver\u00f6ffentlicht · Deutschland", body: "Eine datenschutzfreundliche App zum Aufteilen von Kosten f\u00fcr WGs, Reisen und Paare: ein gemeinsames Konto \u00fcber alle Gruppen, intelligente Kategorisierung auf Deutsch und Englisch und Schulden-Vereinfachung, die alle mit m\u00f6glichst wenigen \u00dcberweisungen ausgleicht. Keine Werbung, kein Paywall, kein Tracking Daten in der EU gespeichert. Von mir allein entworfen, entwickelt und ver\u00f6ffentlicht.", stack: ["Privacy-first", "EN / DE", "Multi-currency", "Dark Mode"], ios: "", android: "https://play.google.com/store/apps/details?id=com.divisum" },
    ],
  },
  contact: {
    eyebrow: "Kontakt",
