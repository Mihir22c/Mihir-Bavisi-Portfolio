...
const en = {
  ...
  about: {
    ...
    p3: "Based in Nuremberg, finishing an M.Eng. in Software Engineering, available full-time from Q3 2026 on a job-seeker visa after thesis submission.",
    f1t: "Native depth",
    ...
    f4t: "Bilingual",
    f4b: "English C1, German B1 (working toward B2).",
  },
  skills: {
    eyebrow: "Skills",
    ...
    groups: [
      ...
      { label: "Frontend", items: ["React (advanced)", "Next.js", "Angular", "TypeScript", "HTML5 / CSS3"] },
      { label: "Backend & APIs", items: ["Kotlin · Spring Boot", "JWT / Spring Security", "Node.js", "REST", "GraphQL"] },
      { label: "Data", items: ["PostgreSQL", "MySQL", "MongoDB", "Firebase Firestore", "SQLDelight / Room / SQLite", "Prisma"] },
      { label: "DevOps", items: ["Docker", "GitHub Actions", "Git (GitLab/GitHub/Bitbucket)", "Vercel"] },
      { label: "Testing & method", items: ["Jest", "React Testing Library", "JUnit 5 / MockK", "Detox (basics)", "Scrum / Kanban"] },
    ],
  },
  exp: {
    eyebrow: "Experience",
    ...
    items: [
      ...
      { when: "11/2022 \u2013 10/2023", role: "Mobile Applications Developer", org: "Orafox (Remote)", place: "Torrance, USA", points: ["Built Natably, a cross-platform React Native app live on the App Store and Play Store", "Developed the APIs syncing data between web and mobile across the product"] },
  ...
  work: {
    ...
    cards: [
      ...
      { tag: "Client app · iOS + Android", name: "Atlantis Circle", org: "Logifox · for Atlantis The Palm", body: "A dining-rewards app for Atlantis Dubai with 20+ restaurants discounts, quick bookings and dining ideas. I built custom UI components and integrated third-party APIs.", stack: ["React Native", "Redux", "REST", "App Store", "Play Store"], ios: "https://apps.apple.com/us/app/the-atlantis-circle/id1664444358", android: "https://play.google.com/store/apps/details?id=com.atlantiscircle" },
...
const de: Dict = {
  ...
  about: {
    ...
    p3: "Wohnhaft in N\u00fcrnberg, kurz vor Abschluss des M.Eng. Software Engineering, verf\u00fcgbar in Vollzeit ab Q3 2026 (Aufenthalt zur Arbeitsplatzsuche nach Studienabschluss).",
    f1t: "Native Tiefe",
    ...
    f4t: "Zweisprachig",
    f4b: "Englisch C1, Deutsch B1 (auf dem Weg zu B2).",
  },
  skills: {
    eyebrow: "Skills",
    ...
    groups: [
      ...
      { label: "DevOps", items: ["Docker", "GitHub Actions", "Git (GitLab/GitHub/Bitbucket)", "Vercel"] },
      { label: "Testing & Methode", items: ["Jest", "React Testing Library", "JUnit 5 / MockK", "Detox (Grundlagen)", "Scrum / Kanban"] },
    ],
  },
  exp: {
    eyebrow: "Erfahrung",
    ...
    items: [
      ...
      { when: "11/2022 \u2013 10/2023", role: "Mobile Applications Developer", org: "Orafox (Remote)", place: "Torrance, USA", points: ["Natably entwickelt eine Cross-Platform-React-Native-App, live im App Store und bei Google Play", "APIs zur Synchronisierung von Daten zwischen Web und Mobile umgesetzt"] },
  ...
  work: {
    ...
    cards: [
      ...
      { tag: "Kundenprojekt · iOS + Android", name: "Atlantis Circle", org: "Logifox · f\u00fcr Atlantis The Palm", body: "Eine Dining-Rewards-App f\u00fcr Atlantis Dubai mit 20+ Restaurants Rabatte, schnelle Buchungen und Dining-Ideen. Ich habe eigene UI-Komponenten gebaut und Drittanbieter-APIs integriert.", stack: ["React Native", "Redux", "REST", "App Store", "Play Store"], ios: "https://apps.apple.com/us/app/the-atlantis-circle/id1664444358", android: "https://play.google.com/store/apps/details?id=com.atlantiscircle" },
