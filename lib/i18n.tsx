...
const en = {
  ...
  skills: {
    ...
    groups: [
      { label: "Mobile", items: ["React Native (5+ yrs, production)", "Android Native (Kotlin, Java)", "Native Modules", "iOS Deployment", ".NET MAUI (basics)"] },
      { label: "Frontend", items: ["React (advanced)", "Next.js", "Angular", "Vue", "TypeScript", "HTML5 / CSS3"] },
      { label: "Backend & APIs", items: ["Node.js", "Express.js", "Spring Boot (basics)", "REST", "GraphQL", "WebSockets"] },
      { label: "Data", items: ["PostgreSQL", "MySQL", "MongoDB", "Firebase Firestore", "SQLite / Realm / Room", "Prisma"] },
      { label: "DevOps", items: ["Docker", "Jenkins", "CircleCI", "Git (GitLab/GitHub/Bitbucket)", "Vercel"] },
      { label: "Testing & method", items: ["Jest", "React Testing Library", "Detox (basics)", "Scrum / Kanban", "Domain-Driven Design"] },
    ],
  },
  exp: {
    eyebrow: "Experience",
  ...
  work: {
    ...
    flagshipTag: "Flagship · in progress",
    flagshipName: "Native Bridge Toolkit",
    flagshipBody: "An open-source Expo + TypeScript app with a custom Kotlin native module, full test coverage and CI the public proof of the native-bridge work I do at work. Shipping soon.",
    flagshipCta: "Watch this repo",
    ghCta: "See all code on GitHub",
  },
  contact: {
    eyebrow: "Contact",
    title: "Let's talk.",
...
const de: Dict = {
  ...
  skills: {
    ...
    groups: [
      { label: "Mobile", items: ["React Native (5+ Jahre, produktiv)", "Android Native (Kotlin, Java)", "Native Modules", "iOS Deployment", ".NET MAUI (Grundlagen)"] },
      { label: "Frontend", items: ["React (Advanced)", "Next.js", "Angular", "Vue", "TypeScript", "HTML5 / CSS3"] },
      { label: "Backend & APIs", items: ["Node.js", "Express.js", "Spring Boot (Grundlagen)", "REST", "GraphQL", "WebSockets"] },
      { label: "Daten", items: ["PostgreSQL", "MySQL", "MongoDB", "Firebase Firestore", "SQLite / Realm / Room", "Prisma"] },
      { label: "DevOps", items: ["Docker", "Jenkins", "CircleCI", "Git (GitLab/GitHub/Bitbucket)", "Vercel"] },
      { label: "Testing & Methode", items: ["Jest", "React Testing Library", "Detox (Grundlagen)", "Scrum / Kanban", "Domain-Driven Design"] },
    ],
  },
  exp: {
    eyebrow: "Erfahrung",
  ...
  work: {
    ...
    flagshipTag: "Flagship · in Arbeit",
    flagshipName: "Native Bridge Toolkit",
    flagshipBody: "Eine Open-Source-App (Expo + TypeScript) mit eigenem Kotlin-Native-Module, voller Testabdeckung und CI der \u00f6ffentliche Beweis f\u00fcr meine Native-Bridge-Arbeit. Bald verf\u00fcgbar.",
    flagshipCta: "Repo beobachten",
    ghCta: "Gesamten Code auf GitHub ansehen",
  },
  contact: {
    eyebrow: "Kontakt",
    title: "Sprechen wir.",
